...
def get_args_parser():
    ...
    parser.add_argument('--project_name', type=str, default='Fine-tuning-SAM-Adapter', help='WandB project name')
...
if __name__ == '__main__': 
    ...
    parser = argparse.ArgumentParser('Training SAM Adapter', parents=[get_args_parser()])
